...
export default function MarketingLayout({
  ...
  return (
    <div className="min-h-screen bg-white text-slate-700 flex flex-col font-sans selection:bg-emerald-100 selection:text-emerald-800">
      {/* Dynamic Header */}
      ...
      <main className="flex-1 w-full relative overflow-hidden bg-white">
        ...
        <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[60%] rounded-full bg-emerald-50 blur-[120px] pointer-events-none" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[60%] rounded-full bg-slate-50 blur-[120px] pointer-events-none" />
        {children}
      </main>
      ...
      <footer className="w-full border-t border-slate-200 bg-slate-50 py-12 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Links columns */}
          <div>
            <h4 className="text-xs font-bold uppercase text-slate-700 tracking-widest mb-4">Industries</h4>
            <ul className="space-y-2 text-xs text-slate-500">
              <li><Link href="/industries" className="hover:text-emerald-700 transition-colors">Healthcare & Patient Intake</Link></li>
              <li><Link href="/industries" className="hover:text-emerald-700 transition-colors">Retail & E-commerce qualification</Link></li>
              <li><Link href="/industries" className="hover:text-emerald-700 transition-colors">Real Estate Lead Screening</Link></li>
              <li><Link href="/industries" className="hover:text-emerald-700 transition-colors">Logistics & Supply chain routing</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-slate-500">
              ...
              <li><Link href="/subscription" className="hover:text-emerald-700 transition-colors">Subscription Pricing Plans</Link></li>
        ...
        <div className="max-w-7xl mx-auto mt-12 pt-6 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-4 text-[11px] text-slate-400">

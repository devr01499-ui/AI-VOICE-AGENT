...
const INDUSTRIES = [
  {
    ...
    subhead: "Automate patient intake, appointment scheduling, and post-discharge follow-up with edge PII protection.",
  ...
  },
  {
    ...
    stats: [{ v: "42%", l: "EMI recovery lift" }, { v: "3s", l: "Speed-to-contact" }, { v: "MSME", l: "Registered" }],
